...
class BeeTireActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener  {
        ...
        FirebaseFirestore
            ...
            .addOnSuccessListener {
                ...
                if(option == "user") {
                    ...
                    PushNotification(
                        NotificationData(
                            "Konfirmasi Pembayaran Kustoemr",
    ...
    private fun saveNotificationFromUserToMitra(formattedDate: String, driverUID: String) {
        ...
        val data = mapOf(
            ...
            "message" to "Order BeeTire menunggu anda",
            "date" to formattedDate,
            "type" to "driver",
            "userId" to driverUID,
            "uid" to uid
            ...
            try {
                ...
                runOnUiThread {
                    if (!response.isSuccessful) {
                        ...
                        Toast.makeText(this@BeeTireActivity, "Token kosong, mohon pastikan koneksi internet anda stabil dan coba lagi", Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (e: Exception) {
